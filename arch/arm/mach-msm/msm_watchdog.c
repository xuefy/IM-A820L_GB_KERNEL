...
#define TZBSP_IMEM_CTX_BUFFER_ADDR  0x2a05f800 //hckim_test
#define TZBSP_WDT_MAGIC_ADDR        0x2A05F66C
 ...
 */
#ifdef CONFIG_PANTECH_APPSBARK_FIQ //20111226_p14291
static int appsbark=0; //20111117_p14291
#else
...
#else
	__raw_writel(32768*30, WDT0_BARK_TIME);
	__raw_writel(32768*31, WDT0_BITE_TIME);
#endif
