...
struct clk_lookup msm_clocks_8x60[] = {
...
#ifdef CONFIG_SKY_TDMB_SPI_QUP
	CLK_8X60("spi_clk",		GSBI2_QUP_CLK, "spi_qsd.5", OFF),
#else
...
#if defined(CONFIG_EF65L_SENSORS_MPU3050) 
	CLK_8X60("gsbi_qup_clk",	GSBI5_QUP_CLK, "qup_i2c.33", OFF),
#else
...
#endif
#if defined(CONFIG_SKY_BATTERY_MAX17040) || defined(CONFIG_SKY_BATTERY_MAX17043)
	CLK_8X60("gsbi_qup_clk",	GSBI11_QUP_CLK,"qup_i2c.16", OFF),	
#else
...
#ifdef CONFIG_SKY_TDMB_SPI_QUP
	CLK_8X60("spi_pclk",		GSBI2_P_CLK, "spi_qsd.5", OFF),
#else
...
#if defined(CONFIG_EF65L_SENSORS_MPU3050) 
	CLK_8X60("gsbi_pclk",		GSBI5_P_CLK, "qup_i2c.33", OFF),
#else
...
#endif
#if defined(CONFIG_SKY_BATTERY_MAX17040) || defined(CONFIG_SKY_BATTERY_MAX17043)
	CLK_8X60("gsbi_pclk",		GSBI11_P_CLK, "qup_i2c.16", OFF),
#else
	...
	CLK_8X60("csi_clk",		CSI1_CLK,	  "msm_camera_mt9d113.0", OFF),
	...
	CLK_8X60("csi_clk",		CSI1_CLK,	  "msm_camera_mt9v113.0", OFF),
#else
...
#ifdef CONFIG_PANTECH_CAMERA_MT9D113
	CLK_8X60("csi_vfe_clk",		CSI1_VFE_CLK,	 "msm_camera_mt9d113.0", OFF),
#elif defined(CONFIG_PANTECH_CAMERA_S5K6AAFX13)
	CLK_8X60("csi_vfe_clk",		CSI1_VFE_CLK,	 "msm_camera_s5k6aafx13.0", OFF),
#elif defined(CONFIG_PANTECH_CAMERA_MT9V113)
	CLK_8X60("csi_vfe_clk",		CSI1_VFE_CLK,	 "msm_camera_mt9v113.0", OFF),
#else
...
#ifdef CONFIG_PANTECH_CAMERA_MT9D113
	CLK_8X60("csi_pclk",		CSI1_P_CLK,	 "msm_camera_mt9d113.0", OFF),
#elif defined(CONFIG_PANTECH_CAMERA_S5K6AAFX13)
	CLK_8X60("csi_pclk",		CSI1_P_CLK,	 "msm_camera_s5k6aafx13.0", OFF),
#elif defined(CONFIG_PANTECH_CAMERA_MT9V113)
	CLK_8X60("csi_pclk",		CSI1_P_CLK,	 "msm_camera_mt9v113.0", OFF),
#else
