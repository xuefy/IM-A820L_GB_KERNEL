...
#ifdef CUSTOMER_HW_PT
	int scan_unassoc_time = 50; //80->60
#else
...
{
#if 0 //lee.eunsuk 20111221 , myLGnet AP disconnect issue     def CUSTOMER_HW_PT
	int bcn_li_dtim;
...
#else
	int bcn_li_dtim;
#if 0 //lee.eunsuk 20111221 , myLGnet AP disconnect issue ; build error
	char buf[128];
#endif 
	int ret;
	uint8 bssid[6];
