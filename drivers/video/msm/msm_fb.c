...
#if 1//defined(CONFIG_FB_MSM_MDP303)
	/*
...
/*20111025, kkcho, 부팅시 hdmi/mhl을 on시키지 않도록 fb0일때만 ON시킨다. Hdmi 는 index가 '1'임. */
#ifdef CONFIG_FB_MSM_HDMI_COMMON  //or CONFIG_FB_MSM_MHL_SII9244
	if (mfd->index == 0) {
#endif
