...
#if (BOARD_REV >= WS20)	
#define CONFIG_INPUT_YAS_MAGNETOMETER_POSITION 3 // bottom-lower-right
#else
...
#define YAS_ERROR_DEVICE_COMMUNICATION      (-4)//LS5 TEAM SHS : ef33s patch [2011-08-17]
...
#define YAS_ERROR_INTERRUPT                 (-9)//LS5 TEAM SHS : ef33s patch [2011-08-17]
...
struct yas_gyro_data { //LS5 TEAM SHS : ef33s patch [2011-08-17]
    struct yas_vector xyz;
    struct yas_vector raw;
    int overrun;
    int num;
...
#ifdef YAS_MAG_MANUAL_OFFSET //LS5 TEAM SHS : ef33s patch [2011-08-17]
    int (*get_manual_offset)(struct yas_vector *offset);
    int (*set_manual_offset)(struct yas_vector *offset);
#endif
#ifdef YAS_MAG_TRANSFORM_MATRIX //LS5 TEAM SHS : ef33s patch [2011-08-17]
...
//LS5 TEAM SHS : ef33s patch [2011-08-17]
